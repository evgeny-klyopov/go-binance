...
[![Build Status](https://travis-ci.org/evgeny-klyopov/go-binance.svg?branch=master)](https://travis-ci.org/evgeny-klyopov/go-binance)
[![GoDoc](https://godoc.org/github.com/evgeny-klyopov/go-binance?status.svg)](https://godoc.org/github.com/evgeny-klyopov/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/evgeny-klyopov/go-binance)](https://goreportcard.com/report/github.com/evgeny-klyopov/go-binance)
[![codecov](https://codecov.io/gh/evgeny-klyopov/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/evgeny-klyopov/go-binance)
...
```shell
go get github.com/evgeny-klyopov/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/evgeny-klyopov/go-binance/v1
```
...
```golang
import (
    "github.com/evgeny-klyopov/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/evgeny-klyopov/go-binance) for full references.
...
```go
import (
    "github.com/evgeny-klyopov/go-binance/v2/futures"
)
...
```go
import (
    "github.com/evgeny-klyopov/go-binance/v2/delivery"
)
